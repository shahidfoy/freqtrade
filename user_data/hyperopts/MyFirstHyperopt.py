...
class MyFirstHyperopt(IHyperOpt):
    """
    ...
    def buy_strategy_generator(params: Dict[str, Any]) -> Callable:
        ...
        def populate_buy_trend(dataframe: DataFrame, metadata: dict) -> DataFrame:
            ...
            if 'trigger' in params:
                ...
                if params['trigger'] == 'bb_middle1':
                    conditions.append(dataframe['close'] < dataframe['bb_middleband1'])
                if params['trigger'] == 'bb_middle3':
                    conditions.append(dataframe['close'] < dataframe['bb_middleband3'])
                if params['trigger'] == 'bb_middle4':
                    conditions.append(dataframe['close'] < dataframe['bb_middleband4'])
